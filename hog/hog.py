...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    pig_one,sum,this_dice = False,0,0
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***" 
    first_digit = player_score
    if player_score > 9 and player_score <= 99:
        first_digit = player_score // 10
    elif player_score > 99:
        first_digit = player_score // 100
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    num_roll0,num_roll1,score_add = 0,0,0
    while score0 <goal and score1 <goal:
        if player == 0:
            num_roll0 = strategy0(score0,score1)
            score_add = take_turn(num_roll0, score1, dice)
            score0 += score_add
            if is_swap(score0, score1):
                score0, score1 = score1, score0             
        if player == 1:
            num_roll1 = strategy1(score1,score0)
            score_add = take_turn(num_roll1, score0, dice)
            score1 += score_add
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0,score1):
        ...
        if who == 0:
            current_score = score0 - ps
            ps = score0
        elif who == 1:
            current_score = score1 - ps
            ps = score1
        if current_score > ph:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    i,highest = 1,0
    while i <= 10:
        i_max = make_averaged(roll_dice, num_samples)(i, dice)
        if i_max > highest:
            highest = i_max
            num = i
        i += 1
